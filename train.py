...
def main():
    data = FramesDataset(3375, './anime_sample_train.txt', './anime_sample')
    ...
    for epoch in range(num_epochs):
        for i_batch, sample_batched in enumerate(dataloader):
            ...
            for d_index in range(d_steps):
                ...
                # 1 is true
                d_real_error = criterion(d_real_decision, Variable(torch.ones(4)))
                ...
                d_fake_error = criterion(d_fake_decision, Variable(torch.zeros(4)))
            ...
            for g_index in range(g_steps):
                ...
                g_error = criterion(dg_fake_decision, Variable(torch.ones(4)))
